    ...
    @if (!empty($news->tiktok_link))
        ...
        @if ($tiktokVideoId)
            <div class="mt-6">
                ...
                <blockquote class="tiktok-embed" cite="https://www.tiktok.com/video/{{ $tiktokVideoId }}" data-video-id="{{ $tiktokVideoId }}" style="max-width: 605px; min-width: 325px;">
                    <iframe 
